...
for m = 1:nM
    ...
    %plot graph
    %createBarGraph(Y,dataSetLegends,legendKeys, cleanString(MName), 'Average', 'Data Sets')
    figure, barweb(Y, Error, 1, dataSetLegends, cleanString(MName), 'Data Sets', 'Average', [], [],legendKeys , 2, 'plot')
    %save as pdf
